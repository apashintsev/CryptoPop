            ...
            <div class="row m-0">
                <div class="col-12 text-center">
                        ...
                        <div class="box-mint">
                            ...
                            <div class="row m-0">
                                <div class="col-3">
                                    <img src="./img/81.png" class="p-4 testimonion">
                                </div>
                                <div class="col-9 p-4 content-mint-2">
                            ...
                            <div class="row m-0">
                                <div class="col-6 quantity">
                                    <span>-</span>
                                    <span class="qm">2</span>
                                    <span>+</span>
                                </div>
                                <div class="col-6 mt-md-3 mt-1">
                                    <button class="bth btn-dark max">set max</button>
                                </div>
                            </div>

                            <div class="row m-0  m-4 mt-5">
                                <div class="col-10 mx-auto">
                                    <button class="btn btn-pink w-100">mint now</button>
                                </div>
                            </div>
